...
const devToolsCards = read("tools/verify_devtools_god_skill_cards_static.js");
const upgradePool = read("tools/verify_fire_skill_upgrade_pool.js");
const devToolsEntry = read("tools/verify_fire_skill_dev_tools_entry_static.js");
